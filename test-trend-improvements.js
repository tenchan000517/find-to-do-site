// 改善されたトレンドシステムのテスト
const { fetchTrendingTopics } = require('./src/lib/trends');
const { categorizeAndExtractKeywords, getDayOfWeekCategory } = require('./src/lib/trend-categorizer');
const { getAllTrends } = require('./src/lib/realtime-trends');
